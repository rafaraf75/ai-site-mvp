...
import { LOCALES, SITE_URL, SITE_NAME, defaultOgImage } from '@/lib/seo';
...
export default async function LocaleLayout({
  ...
  return (
    <>
      ...
      <a href="#content" className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 bg-primary text-primary-foreground px-3 py-2 rounded">Pomiń do treści</a>
      <ThemeProvider>
      ...
      {(process.env.NEXT_PUBLIC_CHAT_WIDGET_ENABLED === '1' || process.env.NEXT_PUBLIC_CHAT_WIDGET_ENABLED === 'true') && (
